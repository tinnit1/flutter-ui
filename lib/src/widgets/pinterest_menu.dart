...
class _PinterestMenuButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final propierties = Provider.of<_MenuModel>(context);
    ...
    return GestureDetector(
      ...
      child: Container(
        child: Icon(
          item.icon,
          size: (propierties.itemSelected == index) ? 35 : 25,
          color: (propierties.itemSelected == index)
              ? propierties.activeColor
              : propierties.inactiveColor,
        ),
      ),
    );
  }
